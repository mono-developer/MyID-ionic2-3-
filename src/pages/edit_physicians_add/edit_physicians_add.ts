...
export class EditPhysiciansAddPage {

  public physicianData:any = { name:'', business_name:'', title:'', address:'', city:'', state:'', country:'', phone_number:'', zip_code:'', is_private: false};
  ...
  constructor(
    ...
    if (navParams.get("physicianData") != null){
      ...
      this.physicianData.is_private = true;
      this.toggleFlag.toggleFlag = !this.physicianData.is_private;
    }
    console.log("physicianData",this.physicianData);
  ...
  physicianDataUpdate(){
    ...
    var body = {"id":this.physicianData.id, "physician":{
                ...
                "zip_code":this.physicianData.zip_code, "is_private":this.physicianData.is_private.toString()}}
    console.log(body);
    loading.present();
    this.storage.get('email').then(val=>{
      this.email = val;
  ...
  notify() {
    this.physicianData.is_private = !this.toggleFlag.toggleFlag;
    if(this.physicianData.is_private == true){
      this.confirmAlert();
    }
    console.log("Toggled: "+ this.physicianData.is_private);
  }
