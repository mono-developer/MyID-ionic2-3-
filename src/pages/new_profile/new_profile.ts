...
export class NewProfilePage {
  ...
  private uploader:MultipartUploader = new MultipartUploader({url: this.baseService.createProfileUrl});

	multipartItem:MultipartItem = new MultipartItem(this.uploader);

  public profile_info: any = {first_name:'Chan', last_name: 'Han', gender:'male', birth_date:'1987-07-24', city:'New York', state:'California', country:'US', zip:'91366'};
  ...
  openDatePicker(){
      this.datePicker.show({
        ...
        date => this.profile_info.birth_date=date,
